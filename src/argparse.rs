        ...
        for arg in &arguments {
            match self::get_arg_index(args, &arg) {
                Some(index) => match args.get(index).unwrap() {
                    argument if argument == arguments.get(0).unwrap() => {
                        config.input_filename = self::get_arg_value(args, &arg)
                    }
                    argument if argument == arguments.get(1).unwrap() => {
                        config.input_filename = self::get_arg_value(args, &arg)
                    }
                    argument if argument == arguments.get(2).unwrap() => {
                        config.output_filename = self::get_arg_value(args, &arg)
                    }
                    argument if argument == arguments.get(3).unwrap() => {
                        config.output_filename = self::get_arg_value(args, &arg)
                    }
                    ...
                    argument if argument == arguments.get(10).unwrap() => {
